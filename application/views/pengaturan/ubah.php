        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="halaman<?= $data['isbn'] ?>">Jumlah Halaman <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <label for="kode_rak<?= $data['isbn'] ?>">Rak Penyimpanan <span class="text-danger">*</span></label>
                        <select class="form-control kode_rak" data-isbn="<?= $data['isbn'] ?>" id="kode_rak<?= $data['isbn'] ?>" name="kode_rak" required>
                            <option value="" selected hidden disabled>-- Pilih Rak Penyimpanan --</option>
                            <?php foreach ($listRak as $rak) : ?>
                                <option value="<?= $rak['kode_rak'] ?>" <?= $data['kode_rak'] == $rak['kode_rak'] ? 'selected' : '' ?>><?= $rak['kode_rak'] . ' - ' . $rak['nama_rak'] ?></option>
                            <?php endforeach; ?>
                        </select>
                        <div class="invalid-feedback feedback_kode_rak" data-isbn="<?= $data['isbn'] ?>"></div>
                    </div>
                    <div class="mb-3">
                        <label for="id_sub_rak<?= $data['isbn'] ?>">Sub Rak Penyimpanan <span class="text-danger">*</span></label>
                        <select class="form-control id_sub_rak" data-isbn="<?= $data['isbn'] ?>" id="id_sub_rak<?= $data['isbn'] ?>" name="id_sub_rak" required>
                            <option value="" selected hidden disabled>-- Pilih Sub Rak Penyimpanan --</option>
                            <?php foreach ($listSubRak as $sub_rak) : ?>
                                <option value="<?= $sub_rak['id_sub_rak'] ?>" <?= $data['id_sub_rak'] == $sub_rak['id_sub_rak'] ? 'selected' : '' ?>><?= $sub_rak['nama_sub_rak'] ?></option>
                            <?php endforeach; ?>
                        </select>
                        <div class="invalid-feedback feedback_id_sub_rak" data-isbn="<?= $data['isbn'] ?>"></div>
                    </div>
                </div>
